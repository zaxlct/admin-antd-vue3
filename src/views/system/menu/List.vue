      ...
      <template #title>
        <ASpace>
          ...
          <AButton
            type="primary"
            ghost
            @click="$router.push('/system/menu/edit')"
          >
            嵌套路由测试
          </AButton>
        </ASpace>
      ...
      >
        ...
        >
          <a-radio-group v-model:value="form.type">
            <a-radio
              v-for="(item, key) in RESOURCE_TYPE"
              :key="key"
              :value="Number(key)"
            >
              {{ item }}
        ...
        <a-form-item
          has-feedback
          :label="`${RESOURCE_TYPE[String(form.type)]}名称`"
          name="title"
        >
